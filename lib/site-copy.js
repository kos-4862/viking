...
const baseCopy = {
  ...
  about: {
    ...
    groups: [
      { ages: "4–7", label: "Початківці" },
      { ages: "8–11", label: "Просунуті" },
      { ages: "12–14", label: "Досвідчені" },
    ],
...
const localeOverrides = {
  en: {
    ...
    about: {
      ...
      groups: [
        { ages: "4–7", label: "Beginners" },
        { ages: "8–11", label: "Intermediate" },
        { ages: "12–14", label: "Advanced" },
      ],
  ...
  ro: {
    ...
    about: {
      ...
      approach: "Stafful nostru de antrenori nu predă doar fotbal — îi învață pe copii să lucreze în echipă, să se ridice după eșecuri și să își asume responsabilitatea.",
      groups: [
        { ages: "4–7", label: "Începători" },
        { ages: "8–11", label: "Avansați" },
        { ages: "12–14", label: "Experimentați" },
      ],
  ...
  ru: {
    ...
    about: {
      ...
      groups: [
        { ages: "4–7", label: "Начинающие" },
        { ages: "8–11", label: "Продвинутые" },
        { ages: "12–14", label: "Опытные" },
      ],
