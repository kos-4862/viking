export const supportedLocales = [
  { code: "ua", label: "Українська", shortLabel: "UA", flag: "🇺🇦" },
...
const baseCopy = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        text: "Регулярні тренування, офіційні чемпіонати Федерації футболу Бухареста (AMFB) та Кубок Stelele Viitorului."
      }
    ]
  },
  about: {
  ...
  advantages: {
    ...
    items: [
      ...
      },
      {
        ...
        text: "Офіційні ігри чемпіонату Федерації футболу Бухареста (AMFB) та Кубок Stelele Viitorului București."
      },
      {
    ...
    items: [
      {
        ...
        a: "Ні. Група від 4 до 7 років — це більше гра, ніж техніка. Через місяць-два всі на одному рівні, а з часом дитина переходить на вищий рівень."
      },
      {
        q: "А якщо дитині не сподобається?",
        a: "Перше тренування безкоштовне, без зобов'язань. Не сподобалось — без проблем."
      },
      {
      ...
      },
      {
        ...
        a: "Тренування проходять на двох майданчиках: D'Angelo Sport (Șoseaua Olteniței Nr 11, Popești-Leordeni) та Premium Wellness Institute (Str. Dumitru Brumărescu 1–3, București, Sector 4). Територія під наглядом. Тренер присутній на кожному занятті."
      },
      {
  ...
  gallery: {
    eyebrow: "Галерея",
    title: "Життя клубу в об'єктиві камер",
  ...
  location: {
    ...
    text: "Тренування на сучасних критих майданчиках у Бухаресті. Територія під наглядом — тільки діти та батьки.",
    photoLabel: "Критий манеж",
    mapUrl: "https://maps.app.goo.gl/DxGoubEvT3mGUJ1R9",
    mapLabel: "Відкрити на карті",
    venues: [
      { name: "D'Angelo Sport", address: "Șoseaua Olteniței Nr 11, Popești-Leordeni", mapUrl: "https://maps.app.goo.gl/AqUaWtgn3u57Zm8T6" },
      { name: "Premium Wellness Institute", address: "Str. Dumitru Brumărescu 1–3, București, Sector 4", mapUrl: "https://maps.app.goo.gl/dTaMaYzdMpETaRy3A" }
    ]
  },
  contact: {
    eyebrow: "Запис на тренування",
    title: "Залиш заявку — ми зв'яжемось",
    orLabel: "або напряму зв'яжіться з тренером"
  },
  contactActions: {
    runtimeNote:
...
const localeOverrides = {
  en: {
    ...
    hero: {
      ...
      lead: "Where children find a team, gain confidence, and discover the real joy of the game",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          num: "03",
          title: "Play and grow",
          text: "Regular training sessions, official Bucharest Football Federation (AMFB) championships, and the Stelele Viitorului Cup."
        }
      ]
    },
    about: {
      ...
      practice: "Regular competitive practice with the best teams in Bucharest: official tournaments of the Bucharest Football Federation (AMFB), the Stelele Viitorului București Cup, and friendly matches.",
    },
    advantages: {
      ...
      items: [
        {
          ...
          text: "Groups of 8–12 children. The coach knows every child and works with their strengths and weaknesses."
        },
        {
        ...
        },
        {
          ...
          text: "Official Bucharest Football Federation (AMFB) championship games and the Stelele Viitorului București Cup."
        },
        {
      ...
      items: [
        {
          ...
          a: "Not at all. The 4 to 7 age group is more about play than technique. Within a month or two everyone is at the same level, and over time your child moves up to the next level."
        },
        {
          q: "What if my child doesn't enjoy it?",
          a: "The first session is free with no commitment. If it's not the right fit — no problem at all."
        },
        {
        ...
        {
          q: "Is the venue safe?",
          a: "Training takes place at two venues: D'Angelo Sport (Șoseaua Olteniței Nr 11, Popești-Leordeni) and Premium Wellness Institute (Str. Dumitru Brumărescu 1–3, București, Sector 4). Supervised access — only children and parents on site. The coach is present at every session."
        },
        {
          q: "Can parents watch?",
    ...
    gallery: {
      eyebrow: "Gallery",
      title: "Club life through the camera lens",
      loadMore: "Show more"
    },
    video: {
    ...
    location: {
      ...
      text: "Training at modern indoor venues in Bucharest. Supervised facilities — only children and parents.",
    ...
    contact: {
      ...
      orLabel: "or contact the coach directly"
    },
    contactActions: {
  ...
  ro: {
    ...
    hero: {
      ...
      cta: "Primul antrenament — gratuit",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          text: "Antrenamente regulate, campionate oficiale ale Federației de Fotbal din București (AMFB) și Cupa Stelele Viitorului."
        }
      ]
    },
    about: {
    ...
    advantages: {
      ...
      items: [
        ...
        },
        {
          ...
          text: "Meciuri oficiale în campionatul Federației de Fotbal din București (AMFB) și Cupa Stelele Viitorului București."
        },
        {
      ...
      items: [
        {
          ...
          a: "Nu. Grupa de la 4 la 7 ani e mai mult joacă decât tehnică. Într-o lună-două toți sunt la același nivel, iar cu timpul copilul trece la nivelul următor."
        },
        {
          q: "Cât costă?",
        ...
        },
        {
          ...
          a: "Primul antrenament e gratuit, fără angajament. Nu i-a plăcut — nicio problemă."
        },
        {
        ...
        },
        {
          ...
          a: "Antrenamentele au loc pe două terenuri: D'Angelo Sport (Șoseaua Olteniței Nr 11, Popești-Leordeni) și Premium Wellness Institute (Str. Dumitru Brumărescu 1–3, București, Sector 4). Acces supravegheat — doar copii și părinți. Antrenorul e prezent la fiecare ședință."
        },
        {
    ...
    gallery: {
      eyebrow: "Galerie",
      title: "Viața clubului în obiectivul camerelor",
    ...
    location: {
      ...
      text: "Antrenamente pe terenuri acoperite moderne din București. Acces supravegheat — doar copii și părinți.",
    ...
    contact: {
      ...
      orLabel: "sau contactează direct antrenorul"
    },
    contactActions: {
  ...
  ru: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          text: "Регулярные тренировки, официальные чемпионаты Федерации футбола Бухареста (AMFB) и Кубок Stelele Viitorului."
        }
      ]
    },
    about: {
    ...
    advantages: {
      ...
      items: [
        ...
        },
        {
          ...
          text: "Официальные игры чемпионата Федерации футбола Бухареста (AMFB) и Кубок Stelele Viitorului București."
        },
        {
      ...
      items: [
        {
          ...
          a: "Нет. Группа от 4 до 7 лет — это больше игра, чем техника. Через месяц-два все на одном уровне, а со временем ребёнок переходит на следующий уровень."
        },
        {
          q: "Сколько стоит?",
        ...
        },
        {
          ...
          a: "Первая тренировка бесплатная, без обязательств. Не понравилось — без проблем."
        },
        {
        ...
        },
        {
          ...
          a: "Тренировки проходят на двух площадках: D'Angelo Sport (Șoseaua Olteniței Nr 11, Popești-Leordeni) и Premium Wellness Institute (Str. Dumitru Brumărescu 1–3, București, Sector 4). Территория под наблюдением. Тренер присутствует на каждом занятии."
        },
        {
    ...
    gallery: {
      eyebrow: "Галерея",
      title: "Жизнь клуба в объективе камер",
    ...
    location: {
      ...
      text: "Тренировки на современных крытых площадках в Бухаресте. Территория под наблюдением — только дети и родители.",
    ...
    contact: {
      ...
      orLabel: "или свяжитесь с тренером напрямую"
    },
    contactActions: {
...
export function getSiteCopy(locale = "ua") {
  if (locale === "ua") {
    return baseCopy;
  }
