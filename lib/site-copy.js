...
const baseCopy = {
  ...
  hero: {
    ...
    cta: "Пробне тренування — безплатно",
    ...
    steps: [
      {
        ...
        text: "Напишіть у WhatsApp або заповніть форму. Перше заняття безплатне, без зобов'язань."
      },
      {
        num: "02",
        title: "Приєднуйтесь до групи",
        text: "Обираєте зручний графік. Через місяць дитина вже частина команди."
      },
      {
        num: "03",
        title: "Граєте і зростаєте",
  ...
  about: {
    ...
    text: "SC Viking — це клуб, створений у 2021 році з простою ідеєю: футбол робить дітей сильнішими не на полі, а в житті. Ростислав і команда тренують не лише техніку — вони вчать працювати з іншими, підніматись після невдач і брати відповідальність. Три вікові групи (4–7, 8–11, 12–14) означають, що кожна дитина тренується на своєму рівні. Граємо в офіційних чемпіонатах AMFB і турнірах Stelele Viitorului București."
  },
  advantages: {
    ...
    items: [
      ...
      {
        title: "Ліцензований тренер",
        text: "Головний тренер Ростислав — ліцензія UEFA C. Сучасні методи, не самодіяльність."
      },
      {
      ...
      {
        title: "Офіційні ігри",
        text: "Чемпіонати під егідою AMFB — Асоціації футболу Бухареста."
      },
      {
        title: "Три вікові групи",
        text: "Групи 4–7, 8–11 та 12–14 років. Кожна дитина — на своєму рівні."
      },
      {
        title: "Товариські турніри",
        text: "Кубки Stelele Viitorului București та інші міські змагання."
      },
      {
  ...
  coach: {
    ...
    bio: "Ростислав не чекає, поки дітям сподобається футбол — він створює умови, щоб їм захотілось повертатись. Кожна дитина отримує конкретний зворотний зв'язок на тренуванні. Турніри — це можливість вчитись, а не іспит.",
    ...
    items: [
      {
        ...
        a: "Ні. Група 4–7 років — це більше гра, ніж техніка. Через місяць-два всі на одному рівні."
      },
      {
        q: "Що якщо дитині не сподобається?",
        a: "Пробне тренування безплатне, без зобов'язань. Не сподобалось — без проблем."
      },
      {
  ...
  contact: {
    ...
    orLabel: "або напишіть тренеру напряму"
  },
  contactActions: {
    runtimeNote:
  ...
  footer: {
    eyebrow: "SC Viking",
    title: "© 2021–2026 SC Viking · Дитяча футбольна школа · Бухарест",
...
const localeOverrides = {
  en: {
    ...
    about: {
      ...
      text: "SC Viking started in 2021 with a simple idea: football makes children stronger not just on the pitch, but in life. Rostyslav and the team coach more than technique — they teach kids how to work with others, bounce back from setbacks, and take responsibility. Three age groups (4–7, 8–11, 12–14) mean every child trains at the right level. We compete in official AMFB championships and Stelele Viitorului București tournaments."
    },
    advantages: {
      ...
      items: [
        ...
        {
          title: "Licensed coach",
          text: "Head coach Rostyslav holds a UEFA C licence. Modern methods, not guesswork."
        },
        {
        ...
        },
        {
          ...
          text: "Championships under the AMFB — Bucharest Football Association."
        },
        {
          title: "Three age groups",
          text: "Groups for ages 4–7, 8–11, and 12–14. Every child trains at the right level."
        },
        {
          title: "Friendly tournaments",
          text: "Stelele Viitorului București cups and other city competitions."
        },
        {
    ...
    coach: {
      ...
      bio: "Rostyslav doesn't wait for children to fall in love with football — he creates the conditions that make them want to come back. Every child gets specific, actionable feedback at each session. Tournaments are a chance to learn, not a test to pass.",
      ...
      items: [
        {
          ...
          a: "Not at all. The 4–7 age group is more about play than technique. Within a month or two everyone is at the same level."
        },
        {
    ...
    footer: {
      title: "© 2021–2026 SC Viking · Children's Football School · Bucharest",
  ...
  ro: {
    ...
    hero: {
      ...
      lead: "Unde copiii găsesc o echipă, capătă încredere în ei și descoperă bucuria adevărată a jocului",
    ...
    about: {
      ...
      text: "SC Viking a început în 2021 dintr-o idee simplă: fotbalul îi face pe copii mai puternici nu pe teren, ci în viață. Rostyslav și echipa nu antrenează doar tehnica — îi învață pe copii să lucreze cu ceilalți, să se ridice după eșecuri și să își asume responsabilitatea. Trei grupe de vârstă (4–7, 8–11, 12–14) înseamnă că fiecare copil se antrenează la nivelul lui. Jucăm în campionatele oficiale AMFB și în turneele Stelele Viitorului București."
    },
    advantages: {
      ...
      items: [
        ...
        {
          title: "Antrenor licențiat",
          text: "Antrenorul principal Rostyslav deține licența UEFA C. Metode moderne, nu improvizație."
        },
        {
        ...
        {
          title: "Jocuri oficiale",
          text: "Campionate sub egida AMFB — Asociația de Fotbal din București."
        },
        {
          title: "Trei grupe de vârstă",
          text: "Grupe pentru 4–7, 8–11 și 12–14 ani. Fiecare copil la nivelul lui."
        },
        {
          title: "Turnee amicale",
          text: "Cupele Stelele Viitorului București și alte competiții din oraș."
        },
        {
    ...
    coach: {
      ...
      bio: "Rostyslav nu așteaptă ca fotbalul să le placă copiilor de la sine — el creează condițiile în care vor să revină. Fiecare copil primește feedback concret la fiecare antrenament. Turneele sunt o ocazie de a învăța, nu un examen.",
      ...
      items: [
        {
          ...
          a: "Nu. Grupa 4–7 ani e mai mult joacă decât tehnică. Într-o lună-două toți sunt la același nivel."
        },
        {
          q: "Cât costă?",
    ...
    footer: {
      title: "© 2021–2026 SC Viking · Școală de fotbal pentru copii · București",
  ...
  ru: {
      ...
      steps: [
        {
          ...
          text: "Напишите в WhatsApp или заполните форму. Первое занятие бесплатное, без обязательств."
        },
        {
          num: "02",
          title: "Присоединяйтесь к группе",
          text: "Выбираете удобное расписание. Через месяц ребёнок уже часть команды."
        },
        {
          num: "03",
          title: "Играете и растёте",
    ...
    about: {
      ...
      text: "SC Viking начался в 2021 году с простой идеи: футбол делает детей сильнее не на поле, а в жизни. Ростислав и команда тренируют не только технику — они учат работать с другими, подниматься после неудач и брать ответственность. Три возрастные группы (4–7, 8–11, 12–14) означают, что каждый ребёнок тренируется на своём уровне. Играем в официальных чемпионатах AMFB и турнирах Stelele Viitorului București."
    },
    advantages: {
      ...
      items: [
        ...
        {
          title: "Лицензированный тренер",
          text: "Главный тренер Ростислав — лицензия UEFA C. Современные методы, а не самодеятельность."
        },
        {
        ...
        {
          title: "Официальные игры",
          text: "Чемпионаты под эгидой AMFB — Ассоциации футбола Бухареста."
        },
        {
          title: "Три возрастные группы",
          text: "Группы 4–7, 8–11 и 12–14 лет. Каждый ребёнок — на своём уровне."
        },
        {
          title: "Товарищеские турниры",
          text: "Кубки Stelele Viitorului București и другие городские соревнования."
        },
        {
    ...
    coach: {
      ...
      bio: "Ростислав не ждёт, пока детям понравится футбол — он создаёт условия, в которых им хочется возвращаться. Каждый ребёнок получает конкретную обратную связь на каждой тренировке. Турниры — это возможность учиться, а не экзамен.",
      ...
      items: [
        {
          ...
          a: "Нет. Группа 4–7 лет — это больше игра, чем техника. Через месяц-два все на одном уровне."
        },
        {
          q: "Сколько стоит?",
    ...
    contact: {
      ...
      orLabel: "или напишите тренеру напрямую"
    },
    contactActions: {
    ...
    footer: {
      title: "© 2021–2026 SC Viking · Детская футбольная школа · Бухарест",
