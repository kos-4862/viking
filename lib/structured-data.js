/**
 * Schema.org structured data for SC Viking football club.
 *
...
const VIDEOS = [
  ...
  { id: "ZF8oyTL2RcA", name: "SC Viking — High Press & Positional Play", desc: "High press, positional play, and combination football training at SC Viking.", duration: "PT38S", date: "2026-03-28" },
  ...
  // New videos (2026-03-29)
  { id: "iOwEwk-vqZ0", name: "SC Viking — When Heroes Are Born", desc: "Penalty shootout drama — SC Viking wins the gold medal!", duration: "PT1M21S", date: "2026-03-29" },
  { id: "hyB0p6DugBU", name: "SC Viking & Dinamo Bucharest — Moment of Silence", desc: "Moment of silence for children killed in Russian missile strike on Kryvyi Rih, April 2025.", duration: "PT18S", date: "2026-03-29" },
  { id: "DRtdYMLNOR0", name: "SC Viking — Speed Training", desc: "Speed and coordination training at SC Viking football club.", duration: "PT38S", date: "2026-03-29" },
  { id: "ALYh1k5FMCQ", name: "SC Viking — Agility Drill", desc: "Agility drill at SC Viking outdoor training session.", duration: "PT1M", date: "2026-03-29" },
  { id: "YdEDcy-CscY", name: "SC Viking — Outdoor Match", desc: "SC Viking outdoor match on the big pitch in Bucharest.", duration: "PT12S", date: "2026-03-29" },
  { id: "YEBbgHFNCsA", name: "SC Viking — Futsal Tournament", desc: "SC Viking competing in the indoor futsal tournament.", duration: "PT13S", date: "2026-03-29" },
];
  ...
  return {
    ...
    "@graph": [
      ...
      // ---------------------------------------------------------------
      {
        ...
        "url": SITE_URL,
        "name": "SC Viking",
        "alternateName": ["scviking", "scviking2021", "SCVB 2021"],
        "description": "Children's football club in Bucharest. Football school for kids ages 4-14. UEFA C licensed coach. Ukrainian-speaking.",
      ...
      // ---------------------------------------------------------------
      {
        ...
        "@id": `${SITE_URL}/#webpage`,
        "url": SITE_URL,
        "name": "SC Viking -- Children's Football Club in Bucharest",
      ...
      // ---------------------------------------------------------------
      {
        ...
        "name": "SC Viking",
        "alternateName": ["SC Viking fotbal club", "scviking", "SC Viking 2021", "SCVB 2021", "Viking FC Bucharest", "Viking Bucharest", "fcvb2021", "SC Viking fotbal", "SC Viking футбол", "SC Viking football club", "SC Viking football club Bucharest", "scviking football club", "SC Viking sector 4", "SC Viking sectorul 4", "SC Viking sector 6", "SC Viking sectorul 6"],
        "url": SITE_URL,
        "logo": `${SITE_URL}/Viking/Logo/sc-viking-emblem.jpg`,
        "image": `${SITE_URL}/images/about-team.jpg`,
        "description": "Children's football club in Bucharest, Romania. Football school for kids, founded in 2021. Three age groups (4-7, 8-11, 12-14). Official AMFB championships and Stelele Viitorului tournaments.",
        "foundingDate": "2021",
        "sport": "Football",
        ...
        "hasMap": "https://maps.app.goo.gl/AqUaWtgn3u57Zm8T6",
        "location": [
          {
            "@type": "SportsActivityLocation",
            "@id": `${SITE_URL}/#venue-dangelo`,
            "name": "D'Angelo Sport Fotbal Si Tenis de Picior",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Șoseaua Olteniței Nr 11",
              "addressLocality": "Popești-Leordeni",
              "postalCode": "042122",
              "addressCountry": "RO"
            },
            "geo": { "@type": "GeoCoordinates", "latitude": 44.3735, "longitude": 26.1270 },
            "hasMap": "https://maps.app.goo.gl/AqUaWtgn3u57Zm8T6"
          },
          {
            "@type": "SportsActivityLocation",
            "@id": `${SITE_URL}/#venue-premium-wellness`,
            "name": "Premium Wellness Institute",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Strada Dumitru Brumărescu 1–3",
              "addressLocality": "București",
              "addressRegion": "Sector 4",
              "addressCountry": "RO"
            },
            "geo": { "@type": "GeoCoordinates", "latitude": 44.4035, "longitude": 26.1160 },
            "hasMap": "https://maps.app.goo.gl/dTaMaYzdMpETaRy3A"
          }
        ],
        "contactPoint": [
          {
      ...
      // ---------------------------------------------------------------
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Training takes place at two venues: D'Angelo Sport (Șoseaua Olteniței Nr 11, Popești-Leordeni) and Premium Wellness Institute (Str. Dumitru Brumărescu 1–3, București, Sector 4). Supervised access — only children and parents on site. The coach is present at every session."
            }
          },
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            "name": "What age can children start football at SC Viking?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Children can join SC Viking from age 4. We have three age groups: beginners (4-7 years), intermediate (8-11 years), and advanced (12-14 years). Each group trains at the appropriate level."
            }
          },
          {
            "@type": "Question",
            "name": "What equipment does my child need for football training?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "For the first session your child only needs comfortable sportswear and indoor football shoes (or clean trainers). The club provides balls and training equipment."
            }
          },
          {
            "@type": "Question",
            "name": "What competitions does SC Viking participate in?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "SC Viking competes in official AMFB (Bucharest Football Federation) championships and the Stelele Viitorului Cup tournament. Teams also play weekly friendly matches against other Bucharest clubs."
            }
          },
          {
            "@type": "Question",
            "name": "Is there a Ukrainian-speaking football club for kids in Bucharest?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. SC Viking's head coach Rostyslav speaks Ukrainian and Russian. The club welcomes Ukrainian diaspora families in Bucharest and provides coaching in a familiar language."
            }
          },
          {
            "@type": "Question",
            "name": "Where is SC Viking located in Bucharest?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "SC Viking trains at two venues in Bucharest Sector 4: (1) D'Angelo Sport, Șoseaua Olteniței Nr 11, 042122 Popești-Leordeni; (2) Premium Wellness Institute, Strada Dumitru Brumărescu 1–3, București. Both facilities are supervised — only children and parents are allowed on site."
            }
          }
        ]
      },
