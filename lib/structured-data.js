...
const VIDEOS = [
  ...
  { id: "DRtdYMLNOR0", name: "SC Viking — Speed Training", desc: "Speed and coordination training at SC Viking Academy.", duration: "PT38S", date: "2026-03-29" },
  ...
  return {
    ...
    "@graph": [
      ...
      // ---------------------------------------------------------------
      {
        ...
        "description": "Children's football club in Bucharest. Ages 4-14. UEFA C licensed coach. Ukrainian-speaking.",
