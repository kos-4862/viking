...
const VIDEOS = [
  ...
  { id: "aba3jME0VTU", name: "SC Viking vs Purple Team — Outdoor Match", desc: "SC Viking playing against the purple team on a full-size outdoor pitch.", duration: "PT4M8S", date: "2026-03-28" },
  ...
  { id: "ZF8oyTL2RcA", name: "SC Viking — Match Under Coach's Eye", desc: "Indoor match with coach directing from the sideline.", duration: "PT38S", date: "2026-03-28" },
  { id: "R_Z0DxhNDxE", name: "SC Viking — Fair Play on the Pitch", desc: "Fair Play spirit at SC Viking training session in Bucharest.", duration: "PT30S", date: "2026-03-28" },
  { id: "z_sypUed8jQ", name: "SC Viking — Training with Coach", desc: "Coach Rostyslav leading a training session with young Vikings.", duration: "PT4S", date: "2026-03-27" },
