...
class Multi_Sports_Loader {
	 ...
	 * @return void
	 */
	public function multi_sports_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function multi_sports_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function multi_sports_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function multi_sports_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->multi_sports_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function multi_sports_load( $class ) {
